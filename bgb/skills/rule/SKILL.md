...
argument-hint: "[game] — [your rules question]"
...
- **Resolve the rules root and the game's folder first** — see
  `${CLAUDE_PLUGIN_ROOT}/references/library.md` (Glob `**/references/library.md` if
...
- Digest template: `${CLAUDE_PLUGIN_ROOT}/references/rules-digest-template.md`
